...
public class RuleAuthoringServiceImpl implements RuleAuthoringService {
    ...
    public RuleAuthoringServiceImpl() throws RuleException{
        super();
        initializeService();
    }
        ...
        try {
            ...
            RuleServiceProviderManager
                            .registerRuleServiceProvider(
                                            ...
                                            Class.forName("edu.duke.cabig.c3pr.rules.runtime.RuleServiceProviderImpl"));
    ...
    public RuleSet getRuleSet(String ruleSetName, boolean cached) throws RemoteException, RuleException {
