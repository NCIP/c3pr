 ...
 * 
 */
public class AccrualServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://accrualservice.grid.c3pr.cabig.duke.edu/AccrualService";
	
	
	public AccrualServiceAuthorization() {
	}
	...
	public static void authorizeGetSiteAccrualReport() throws RemoteException {
		
		
	}
					
	public static void authorizeGetDiseaseSiteAccrualReports() throws RemoteException {
		
		
	}
					
	public static void authorizeGetSiteCtepId() throws RemoteException {
		
		
	}
					
	public static void authorizeGetStudyAccrualReports() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("getSiteAccrualReport")){
			try{
				authorizeGetSiteAccrualReport();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getDiseaseSiteAccrualReports")){
			try{
				authorizeGetDiseaseSiteAccrualReports();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getSiteCtepId")){
			try{
				authorizeGetSiteCtepId();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
			}
		} else if(operation.getLocalPart().equals("getStudyAccrualReports")){
			try{
				authorizeGetStudyAccrualReports();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
