...
SET IDENTITY_INSERT INVESTIGATORS ON
...
SET IDENTITY_INSERT HC_SITE_INVESTIGATORS ON
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10001', '1','HC_SITE ID1', 'Open', GETDATE(), '10001','10001');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10002', '1','HC_SITE ID2', 'Open', GETDATE(), '10002','10001');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10003', '1','HC_SITE ID3', 'Open', GETDATE(), '10003','10001');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10004', '1','HC_SITE ID4', 'Open', GETDATE(), '10005','10002');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10005', '1','HC_SITE ID5', 'Open', GETDATE(), '10008','10002');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10006', '1','HC_SITE ID6', 'Open', GETDATE(), '10009','10002');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10007', '1','HC_SITE ID7', 'Open', GETDATE(), '10003','10003');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10008', '1','HC_SITE ID8', 'Open', GETDATE(), '10005','10003');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10009', '1','HC_SITE ID9', 'Open', GETDATE(), '10003','10004');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10010', '1','HC_SITE ID10', 'Open', GETDATE(), '10004','10004');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10011', '1','HC_SITE ID11', 'Open', GETDATE(), '10007','10004');
INSERT INTO HC_SITE_INVESTIGATORS (ID,VERSION,GRID_ID,STATUS_CODE,STATUS_DATE,INV_ID,HCS_ID)
VALUES ('10012', '1','HC_SITE ID12', 'Open', GETDATE(), '10009','10004');
SET IDENTITY_INSERT HC_SITE_INVESTIGATORS OFF

SET IDENTITY_INSERT RESEARCH_STAFF ON
...
SET IDENTITY_INSERT RESEARCH_STAFF OFF

SET IDENTITY_INSERT anatomic_sites ON
...
SET IDENTITY_INSERT anatomic_sites OFF