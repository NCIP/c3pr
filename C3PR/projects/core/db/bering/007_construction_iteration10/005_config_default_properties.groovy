class ConfigDefaultProperties extends edu.northwestern.bioinformatics.bering.Migration {
	void up() {
		...
		if (databaseMatches('sqlserver')) {		
			...
			insert('configuration', [ key_ms:"ccts.websso.cert_file", value:"/System/Library/Frameworks/JavaVM.framework/Versions/1.5.0/Home/lib/security/cacerts" ], primaryKey: false)
