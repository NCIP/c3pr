 ...
 * 
 */
public abstract class RegistrationServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(RegistrationServiceResourceBase.class);

	private RegistrationServiceResourceConfiguration configuration;
    ...
    public RegistrationServiceResourceBase() {
    }
	...
	public RegistrationServiceResourceConfiguration getConfiguration() {
		...
		servicePath+="/RegistrationService";
		...
		try {
			...
			this.configuration = (RegistrationServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
