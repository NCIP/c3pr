...
package edu.duke.cabig.c3pr.grid.stubs.service;

public class StudyServiceLocator extends org.apache.axis.client.Service implements edu.duke.cabig.c3pr.grid.stubs.service.StudyService {
    ...
    public edu.duke.cabig.c3pr.grid.stubs.StudyServicePortType getStudyServicePortTypePort() throws javax.xml.rpc.ServiceException {
    ...
    public edu.duke.cabig.c3pr.grid.stubs.StudyServicePortType getStudyServicePortTypePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.duke.cabig.c3pr.grid.stubs.bindings.StudyServicePortTypeSOAPBindingStub _stub = new edu.duke.cabig.c3pr.grid.stubs.bindings.StudyServicePortTypeSOAPBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.duke.cabig.c3pr.grid.stubs.StudyServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.duke.cabig.c3pr.grid.stubs.bindings.StudyServicePortTypeSOAPBindingStub _stub = new edu.duke.cabig.c3pr.grid.stubs.bindings.StudyServicePortTypeSOAPBindingStub(new java.net.URL(StudyServicePortTypePort_address), this);
                _stub.setPortName(getStudyServicePortTypePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://grid.c3pr.cabig.duke.edu/StudyService/service", "StudyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://grid.c3pr.cabig.duke.edu/StudyService/service", "StudyServicePortTypePort"));
        }
