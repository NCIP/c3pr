...
package edu.duke.cabig.c3pr.grid.studyservice.stubs.types;
...
public class StudyServiceReference  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://studyservice.grid.c3pr.cabig.duke.edu/StudyService/types", ">StudyServiceReference"));
