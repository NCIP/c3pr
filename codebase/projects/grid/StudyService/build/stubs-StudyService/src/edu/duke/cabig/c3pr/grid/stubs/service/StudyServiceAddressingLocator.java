...
public class StudyServiceAddressingLocator extends edu.duke.cabig.c3pr.grid.stubs.service.StudyServiceLocator implements edu.duke.cabig.c3pr.grid.stubs.service.StudyServiceAddressing {
    public edu.duke.cabig.c3pr.grid.stubs.StudyServicePortType getStudyServicePortTypePort(org.apache.axis.message.addressing.EndpointReferenceType reference) throws javax.xml.rpc.ServiceException {
	...
	edu.duke.cabig.c3pr.grid.stubs.StudyServicePortType _stub = getStudyServicePortTypePort(endpoint);
	if (_stub != null) {
