...
public class StudyServiceAuthorization implements PDP {
	...
	public static void authorizeCreateAndOpenStudy() throws RemoteException {
		studyAuthorization.authorizeCreateAndOpenStudy(getCallerIdentity());
	}
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("createAndOpenStudy")){
			try{
				authorizeCreateAndOpenStudy();
				return true;
			} catch (Exception e){
				e.printStackTrace();
				return false;
