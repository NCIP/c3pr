/**
 * AccrualServiceReference.java
 *
 * This file was auto-generated from WSDL
 * by the Apache Axis 1.2RC2 Apr 28, 2006 (12:42:00 EDT) WSDL2Java emitter.
 */

package edu.duke.cabig.c3pr.grid.accrualservice.stubs.types;

public class AccrualServiceReference  implements java.io.Serializable {
    private org.apache.axis.message.addressing.EndpointReferenceType endpointReference;

    public AccrualServiceReference() {
    }
    ...
    /**
     * Gets the endpointReference value for this AccrualServiceReference.
     * 
    ...
    /**
     * Sets the endpointReference value for this AccrualServiceReference.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AccrualServiceReference)) return false;
        AccrualServiceReference other = (AccrualServiceReference) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AccrualServiceReference.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://accrualservice.grid.c3pr.cabig.duke.edu/AccrualService/types", ">AccrualServiceReference"));
