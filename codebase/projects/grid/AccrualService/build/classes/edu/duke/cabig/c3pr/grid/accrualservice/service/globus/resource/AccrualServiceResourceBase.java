...
import edu.duke.cabig.c3pr.grid.accrualservice.service.AccrualServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class AccrualServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(AccrualServiceResourceBase.class);

	private AccrualServiceResourceConfiguration configuration;
    ...
    public AccrualServiceResourceBase() {
    }
	...
	public AccrualServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (AccrualServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
