...
public class C3PRStudyConsumerProviderImpl{
    ...
    public edu.duke.cabig.c3pr.grid.stubs.CreateOrUpdateResponse createOrUpdate(edu.duke.cabig.c3pr.grid.stubs.CreateOrUpdateRequest params) throws RemoteException, edu.duke.cabig.c3pr.grid.stubs.types.InvalidStudyException, edu.duke.cabig.c3pr.grid.stubs.types.StudyCreateOrUpdateException {
    ...
    impl.createOrUpdate(params.getStudy().getStudy());
    return boxedResult;
  }
