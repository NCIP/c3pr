 ...
 * 
 */
public class C3PRStudyConsumerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://grid.c3pr.cabig.duke.edu/C3PRStudyConsumer";
	
	
	public C3PRStudyConsumerAuthorization() {
	}
	...
	public static void authorizeCreateOrUpdate() throws RemoteException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		} else if(operation.getLocalPart().equals("createOrUpdate")){
			try{
