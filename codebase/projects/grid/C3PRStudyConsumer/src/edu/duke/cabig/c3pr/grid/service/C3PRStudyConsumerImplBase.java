...
import edu.duke.cabig.c3pr.grid.service.globus.resource.BaseResource;
import edu.duke.cabig.c3pr.grid.service.ServiceConfiguration;
 ...
 * 
 */
public abstract class C3PRStudyConsumerImplBase {
	
	public C3PRStudyConsumerImplBase() throws RemoteException {
	...
	public edu.duke.cabig.c3pr.grid.service.globus.resource.BaseResourceHome getResourceHome() throws Exception {
		ResourceHome resource = getResourceHome("home");
		return (edu.duke.cabig.c3pr.grid.service.globus.resource.BaseResourceHome)resource;
	}
