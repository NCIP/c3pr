class NciCodeMigration extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
        ...
        if (databaseMatches('oracle')) {
        	execute("insert into identifiers (\"id\", \"version\", \"retired_indicator\", \"dtype\", \"type\", \"primary_indicator\", \"value\", \"org_id\", \"hcs_id\") select identifiers_ID_SEQ.nextval, 0, 'false', 'OAI', 'CTEP', 'TRUE', \"nci_institute_code\",\"id\", 19917 from organizations");
        }
    }
