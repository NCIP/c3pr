class RefactorStudyOrganizations extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
	    	...
	    	execute("alter table STUDY_PERSONNEL drop constraint FK_STDPER_STDSIT")
	    	...
	    	dropColumn('STUDY_PERSONNEL', "STS_ID")
	    	addColumn('STUDY_PERSONNEL', "STO_ID", "integer")
			...
			execute("alter table STUDY_PERSONNEL add constraint FK_STDPER_STO FOREIGN KEY (STO_ID) REFERENCES STUDY_ORGANIZATIONS (ID)")
    ...
    void down() {
    		...
    		execute("alter table STUDY_PERSONNEL drop constraint FK_STDPER_STO")
	    	...
	    	addColumn('STUDY_SUBJECTS', "STS_ID", "string")
   	    	dropColumn('STUDY_PERSONNEL', "STO_ID")
	    	addColumn('STUDY_PERSONNEL', "STS_ID", "string")
	    	...
	    	execute("alter table STUDY_PERSONNEL add CONSTRAINT FK_STDPER_STDSIT FOREIGN KEY (STS_ID) REFERENCES STUDY_SITES (ID)")
