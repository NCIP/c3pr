class StudyUniqueConstraints extends edu.northwestern.bioinformatics.bering.Migration {
    ...
    void down() {
   		...
   		execute(" ALTER TABLE STUDY_INVESTIGATORS add CONSTRAINT UK_STU_INV")
   		execute("ALTER TABLE HC_SITE_INVESTIGATORS add CONSTRAINT UK_ORG")
   		execute("ALTER TABLE RESEARCH_STAFF add CONSTRAINT UK_RSF")
