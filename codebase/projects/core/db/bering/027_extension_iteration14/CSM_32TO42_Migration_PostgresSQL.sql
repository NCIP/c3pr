...
--CSM_APPLICATION updates
ALTER TABLE csm_application ALTER application_id TYPE int8;
ALTER TABLE csm_application ADD COLUMN csm_version character varying(20);
ALTER TABLE csm_application ALTER update_date TYPE date;
ALTER TABLE csm_application ALTER COLUMN update_date SET DEFAULT current_date;
update csm_application set update_date = current_date;
ALTER TABLE csm_application ALTER COLUMN update_date SET NOT NULL;

--CSM_USER updates
ALTER TABLE csm_user ALTER user_id TYPE int8;
ALTER TABLE csm_user ALTER start_date TYPE date;
ALTER TABLE csm_user ALTER end_date TYPE date;
ALTER TABLE csm_user ALTER update_date TYPE date;
ALTER TABLE csm_user ALTER COLUMN update_date SET DEFAULT current_date;
update csm_user set update_date = current_date;
ALTER TABLE csm_user ALTER COLUMN update_date SET NOT NULL;
ALTER TABLE csm_user ALTER login_name TYPE character varying(500);
...
--CSM_GROUP updates
ALTER TABLE csm_group ALTER update_date TYPE date;
ALTER TABLE csm_group ALTER COLUMN update_date SET DEFAULT current_date;
update csm_group set update_date = current_date;
ALTER TABLE csm_group ALTER COLUMN update_date SET NOT NULL;
ALTER TABLE csm_group ALTER application_id TYPE int8;
ALTER TABLE csm_group ALTER group_id TYPE int8;
...
--CSM_USER_GROUP updates
--DROP SEQUENCE IF EXISTS csm_user_group_id_seq;
--CREATE SEQUENCE CSM_USER_GROU_USER_GROUP_I_SEQ;
--ALTER SEQUENCE CSM_USER_GROU_USER_GROUP_I_SEQ RESTART WITH 3000;
ALTER TABLE csm_user_group ALTER COLUMN user_group_id SET DEFAULT nextval('CSM_USER_GROU_USER_GROUP_I_SEQ');
ALTER TABLE csm_user_group ALTER group_id TYPE int8;
ALTER TABLE csm_user_group ALTER user_id TYPE int8;
...
--CREATE TRIGGER SET_CSM_PG_PE_UPDATE_DATE BEFORE UPDATE ON CSM_PG_PE FOR EACH ROW EXECUTE PROCEDURE SET_CSM_PG_PE_UPDATE_DATE();
