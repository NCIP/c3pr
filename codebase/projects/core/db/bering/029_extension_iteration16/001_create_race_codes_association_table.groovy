class CreateRaceCodeAssociationsTable extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
    	...
    	if (databaseMatches('oracle')) {
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'Asian' from dual, participants where race_code like '%Asian%')")
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'White' from dual, participants where race_code like '%White%')")
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'Black_or_African_American' from dual, participants where race_code like '%Black_or_African_American%')")
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'American_Indian_or_Alaska_Native' from dual, participants where race_code like '%American_Indian_or_Alaska_Native%')")
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'Native_Hawaiian_or_Pacific_Islander' from dual, participants where race_code like '%Native_Hawaiian_or_Pacific_Islander%')")
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'Not_Reported' from dual, participants where race_code like '%Not_Reported%')")
	   		execute("INSERT INTO race_code_assocn (id,version,sub_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, participants.id,  'Unknown' from dual, participants where race_code like '%Unknown%')")
	   		
	   		execute("INSERT INTO race_code_assocn (id,version,stu_sub_dmgphcs_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, stu_sub_demographics.id,  'Asian' from dual, stu_sub_demographics where race_code like '%Asian%')")
	   		execute("INSERT INTO race_code_assocn (id,version,stu_sub_dmgphcs_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, stu_sub_demographics.id,  'White' from dual, stu_sub_demographics where race_code like '%White%')")
	   		execute("INSERT INTO race_code_assocn (id,version,stu_sub_dmgphcs_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, stu_sub_demographics.id,  'Black_or_African_American' from dual, stu_sub_demographics where race_code like '%Black_or_African_American%')")
	   		execute("INSERT INTO race_code_assocn (id,version,stu_sub_dmgphcs_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, stu_sub_demographics.id,  'American_Indian_or_Alaska_Native' from dual, stu_sub_demographics where race_code like '%American_Indian_or_Alaska_Native%')")
	   		execute("INSERT INTO race_code_assocn (id,version,stu_sub_dmgphcs_id,race_code) (select race_code_assocn_id_SEQ.nextval,1, stu_sub_demographics.id,  'Native_Hawaiian_or_Pacific_Islander' from dual, stu_sub_demographics where race_code like '%Native_Hawaiian_or_Pacific_Islander%')")
