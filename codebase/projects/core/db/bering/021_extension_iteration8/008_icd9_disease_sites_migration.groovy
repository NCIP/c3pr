class ICD9DiseaseSitesMigration extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
    	 ...
    	 execute("update disease_history set other_disease_site_code = anatomic_sites.name from anatomic_sites where disease_history.anatomic_site_id = anatomic_sites.id");
    	 execute("alter table disease_history add column icd9_disease_site_id integer");
