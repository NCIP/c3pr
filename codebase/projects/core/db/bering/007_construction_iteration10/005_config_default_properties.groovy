class ConfigDefaultProperties extends edu.northwestern.bioinformatics.bering.Migration {
	void up() {
		...
		if (databaseMatches('sqlserver')) {		
			...
			insert('configuration', [ key_ms:"outgoingMailServer", value:"" ], primaryKey: false)
			insert('configuration', [ key_ms:"outgoingMailServerPort", value:"465" ], primaryKey: false)
			insert('configuration', [ key_ms:"outgoingMailAuth", value:"" ], primaryKey: false)
		...
		insert('configuration', [ key:"outgoingMailServer", value:"" ], primaryKey: false)
		insert('configuration', [ key:"outgoingMailServerPort", value:"465" ], primaryKey: false)
		insert('configuration', [ key:"outgoingMailAuth", value:"" ], primaryKey: false)
