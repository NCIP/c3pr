...
ALTER TABLE RESEARCH_STAFFS ADD CONSTRAINT FK_RS_ADD
...
ALTER TABLE CONTACT_MECHANISMS ADD CONSTRAINT PK_CONTACT_MECHANISMS
	PRIMARY KEY (ID) ;
...
ALTER TABLE RESEARCH_STAFFS ADD CONSTRAINT FK_RS_HCS
	FOREIGN KEY (HCS_ID) REFERENCES HEALTHCARE_SITES(ID);
