...
public enum APIName implements CodedEnum<String> {
    ...
    CLOSE_STUDY_TO_ACCRUAL_TO_TREATMNET("closeStudyToAccrualAndTreatment", "Close Study To Accrual And Treatement"),
    TEMPORARILY_CLOSE_STUDY_TO_ACCRUAL("temporarilyCloseStudyToAccrual", "Temporarily Close Study To Accrual And Treatment"),
    TEMPORARILY_CLOSE_STUDY_TO_ACCRUAL_TO_TREATMNET("temporarilyCloseStudyToAccrualAndTreatment", "Temporarily Close Study To Accrual And Treatement And Treatment"),
    UDATE_STUDY("updateStudy", "Update Study"), 
    CLOSE_STUDY_SITE_TO_ACCRUAL("closeStudySiteToAccrual", "Close Study Site To Accrual"),
    CLOSE_STUDY_SITE_TO_ACCRUAL_TO_TREATMNET("closeStudySiteToAccrualAndTreatment", "Close Study Site To Accrual And Treatement"),
    ...
    TEMPORARILY_CLOSE_STUDY_SITE_TO_ACCRUAL_TO_TREATMNET("temporarilyCloseStudySiteToAccrualAndTreatment", "Temporarily Close Study Site To Accrual And Treatement And Treatment"),
