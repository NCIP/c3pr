 ...
 * 
 * Created by IntelliJ IDEA. User: kherm Date: Jun 4, 2007 Time: 1:30:38 PM To change this template
 * use File | Settings | File Templates.
 */
public class StudyValidationException extends C3PRBaseException {

    public StudyValidationException() {
        super("Invalid Study"); // To change body of overridden methods use File | Settings | File
                                // Templates.
    }
    ...
    public StudyValidationException(String s, Throwable throwable) {
        super(s, throwable); // To change body of overridden methods use File | Settings | File
                                // Templates.
    }
}
