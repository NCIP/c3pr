 ...
 */
public class Summary3ReportXmlMarshaller implements Marshaller, Unmarshaller {

    private Logger log = Logger.getLogger(Summary3ReportXmlMarshaller.class.getName());
 ...
 //   private List<String> commonMappingFiles= Arrays.asList("common-mapping.xml");
	...
	public Summary3ReportXmlMarshaller() {
        marshaller = new caCOREMarshaller();
        unmarshaller = new caCOREUnmarshaller();
    }

    public Summary3ReportXmlMarshaller(String castorMappingFile) {
        this();
