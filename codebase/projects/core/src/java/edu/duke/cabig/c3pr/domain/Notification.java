...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "NOTIFICATIONS_ID_SEQ") })
public class Notification extends AbstractMutableDeletableDomainObject {
    ...
    public Notification() {
        ...
        lazyListHelper.add(EmailBasedRecipient.class, new InstantiateFactory<EmailBasedRecipient>(
                        EmailBasedRecipient.class));
    ...
    public void setEmailBasedRecipientInternal(List<EmailBasedRecipient> emailBasedRecipient) {
    ...
    public void setEmailBasedRecipient(List<EmailBasedRecipient> emailBasedRecipient) {
    }
