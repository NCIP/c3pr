...
import gov.nih.nci.security.acegi.grid.authentication.AuthenticationErrorException;

/**
 * @author <a href="mailto:joshua.phillips@semanticbits.com>Joshua Phillips</a>
 * 
 */
public class GridBasicAuthenticationClientImpl {
    ...
    public String authenticate(String usr, String pwd) throws AuthenticationErrorException {
        ...
        try {
            ...
            throw new AuthenticationErrorException(
                            "Error instantiating AuthenticationServiceClient: " + ex.getMessage(),
                            ex);
        }
        ...
        try {
            ...
            throw new AuthenticationErrorException("Error getting SAMLAssertion: "
                            + ex.getMessage());
        }
        ...
        if (saml != null) {
            ...
            try {
                ...
                throw new AuthenticationErrorException("Error generating key pair: "
                                + ex.getMessage(), ex);
            }
            ...
            try {
                ...
                throw new AuthenticationErrorException("Error parsing SAMLAssertion: "
                                + ex.getMessage(), ex);
            }
            ...
            try {
                ...
                throw new AuthenticationErrorException("Error getting proxy: " + ex.getMessage(),
                                ex);
            }
            if (list != null) {
                ...
                for (int i = 0; i < list.length; i++) {
                    try {
                        ...
                        throw new AuthenticationErrorException("Error loading certificate: "
                                        + ex.getMessage(), ex);
                    }
                }
