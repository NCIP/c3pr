...
public enum StudyDisplayPageEnum implements CodedEnum<String>{
    ...
    private StudyDisplayPageEnum(String code) {
        this.code = code;
        register(this);
    }
    ...
    public static StudyDisplayPageEnum getByCode(String code) {
        return getByClassAndCode(StudyDisplayPageEnum.class, code);
    }
