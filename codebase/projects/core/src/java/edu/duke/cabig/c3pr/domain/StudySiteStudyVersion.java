...
public class StudySiteStudyVersion extends AbstractMutableDeletableDomainObject implements Comparable<StudySiteStudyVersion>{
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((studySite == null) ? 0 : studySite.hashCode());
		result = prime * result
				+ ((studyVersion == null) ? 0 : studyVersion.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StudySiteStudyVersion other = (StudySiteStudyVersion) obj;
		if (studySite == null) {
			if (other.studySite != null)
				return false;
		} else if (!studySite.equals(other.studySite))
			return false;
