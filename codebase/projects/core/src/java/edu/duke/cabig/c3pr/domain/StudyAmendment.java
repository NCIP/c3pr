...
@GenericGenerator(name = "id-generator", strategy = "native", parameters = { @Parameter(name = "sequence", value = "STUDY_AMENDMENTS_ID_SEQ") })
public class StudyAmendment extends AbstractMutableDeletableDomainObject {
    ...
    public void setRandomizationChangedIndicator(Boolean randomizationChangedIndicator) {
