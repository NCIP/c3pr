...
public class StudyCastorMappingTestCase extends AbstractTestCase{
	...
	public Study getStudyWithDetails(RandomizationType randomizationType){
	...
	public void addCooCenterAndIdentifier(Study study){
	...
	public void addFundingSponsorAndIdentifier(Study study){
	...
	public void addPI(StudyOrganization studyOrganization){
	...
	public void addConsent(Study study){
	...
	public void addStudyDesign(Study study){
	...
	public void addStratification(Epoch epoch){
	...
	public void addRandomization(Study study, Epoch epoch){
	...
	public void addDisease(Study study){
	...
	public void addStudySites(Study study){
		study.addStudySite(createStudySite(true));
		study.addStudySite(createStudySite(false));
	}
	
	public void addInvestigators(StudyOrganization studyOrganization){
		StudyInvestigator studyInvestigator1= studyOrganization.getStudyInvestigators().get(0);
	...
	public StudySite createStudySite(boolean local){
	...
	public HealthcareSite createHealthcareSite(boolean local){
	...
	public void addCompanions(Study study){
