...
public class StudySubjectServiceTestCase extends DaoTestCase {
    ...
    public void testEvaluateRegistrationDataEntryStatusInComplete() throws Exception {
        ...
        assertEquals("Wrong Registration Data Entry Status",
                        RegistrationDataEntryStatus.INCOMPLETE, studySubjectService
    ...
    public void testEvaluateRegistrationDataEntryStatusComplete() {
        ...
        assertEquals("Wrong Registration Data Entry Status", RegistrationDataEntryStatus.COMPLETE,
                        studySubjectService.evaluateRegistrationDataEntryStatus(studySubject));
    }
    ...
    public void testCreateRegistrationCase1() throws Exception {
        studySubjectService.setHostedMode(false);
        StudySubject studySubject = new StudySubject();
        studySubject.setStudySite(getMultiSiteRandomizedStudy(RandomizationType.CALL_OUT, false)
                        .getStudySites().get(0));
        studySubject.setParticipant(participantDao.getById(1000));
        Integer savedId;
        {
    ...
    public void testCreateRegistrationCase3() throws Exception {
        StudySubject studySubject = new StudySubject();
        studySubject.setStudySite(getLocalRandomizedStudy(RandomizationType.PHONE_CALL, false)
                        .getStudySites().get(0));
        studySubject.setParticipant(participantDao.getById(1000));
        Integer savedId;
        {
    ...
    public void testCreateRegistrationCase9() throws Exception {
        studySubjectService.setHostedMode(false);
        StudySubject studySubject = new StudySubject();
        studySubject.setStudySite(getMultiSiteNonRandomizedStudy(true, false, false)
                        .getStudySites().get(0));
        studySubject.setParticipant(participantDao.getById(1000));
        Integer savedId;
        {
