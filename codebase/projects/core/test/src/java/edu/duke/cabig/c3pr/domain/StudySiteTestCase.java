...
public class StudySiteTestCase extends AbstractTestCase {
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * ClosedToAccrual
	 * 
	 * @throws Exception
	 *             the exception
	...
	public void testEvaluateSiteStudyStatus1() throws Exception {
		...
		assertEquals(SiteStudyStatus.CLOSED_TO_ACCRUAL, studySite
				.evaluateSiteStudyStatus());
		verifyMocks();
	}

	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * ClosedToAccrualAndTreatment
	 * 
	 * @throws Exception
	 *             the exception
	 */
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * TemporarilyClosedToAccrualAndTreatment
	 * 
	 * @throws Exception
	 *             the exception
	 */
	public void testEvaluateSiteStudyStatus4() throws Exception {
		...
		EasyMock.expect(study.getLatestActiveStudyVersion()).andReturn(null);
		EasyMock
				.expect(study.getCoordinatingCenterStudyStatus())
				.andReturn(
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: null id: not null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	public void testEvaluateSiteStudyStatus6() throws Exception {
		...
		EasyMock.expect(study.getCoordinatingCenterStudyStatus()).andReturn(
				CoordinatingCenterStudyStatus.OPEN).times(5);
		EasyMock
				.expect(
						messageSource
								.getMessage(
		...
		// EasyMock.expect(c3PRExceptionHelper.getException(EasyMock.isA(Integer.class),new
		// String[] { EasyMock.isA(String.class)
		// })).andReturn(c3CodedException);
		EasyMock.expect(
				c3PRExceptionHelper.getException(EasyMock.anyInt(), EasyMock
						.isA(String[].class))).andReturn(c3CodedException);
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: null id: null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	public void testEvaluateSiteStudyStatus7() throws Exception {
		...
		replayMocks();
		studySite.setStudy(study);
		assertEquals(SiteStudyStatus.PENDING, studySite
				.evaluateSiteStudyStatus());
		verifyMocks();
	}
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: Future id: null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: expired id: null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: correct startDate: null id: not null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: correct startDate: Future id: not null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: correct startDate: null id: null
	 * 
	 * @throws Exception
	 *             the exception
	 */
	...
	/**
	 * Test evaluate site study status. study.coordinatingCenterStudyStatus:
	 * Open irbApprovalDate: correct startDate: correct
	 * 
	 * @throws Exception
	 *             the exception
	 */
	public void testEvaluateSiteStudyStatus15() throws Exception {
		...
		replayMocks();
		studySite.setStudy(study);
		assertEquals(SiteStudyStatus.ACTIVE, studySite
				.evaluateSiteStudyStatus());
		verifyMocks();
	}
	...
	public void testEvaluateSiteStudyStatus16() throws Exception {
		...
		studySite.setStartDate(new Date());
		EasyMock.expect(study.getCoordinatingCenterStudyStatus()).andReturn(
				CoordinatingCenterStudyStatus.PENDING).times(5);
		replayMocks();
		studySite.setStudy(study);
		assertEquals(SiteStudyStatus.PENDING, studySite
				.evaluateSiteStudyStatus());
	...
	public void testEvaluateSiteStudyStatus17() throws Exception {
		...
		studySite.setStartDate(new Date());
		EasyMock.expect(study.getCoordinatingCenterStudyStatus()).andReturn(
				CoordinatingCenterStudyStatus.READY_TO_OPEN).times(5);
		replayMocks();
		studySite.setStudy(study);
		assertEquals(SiteStudyStatus.PENDING, studySite
				.evaluateSiteStudyStatus());
