...
/**
 * This controller is used to download files from the UI.
 * These files should be on the classpath
 *
...
public class ResourceDownloadController implements Controller {
    ...
    public ModelAndView handleRequest(HttpServletRequest request,
        ...
        int fSize = 0;
        try {
            String filePath=System.getenv("CATALINA_HOME")+System.getProperty("file.separator")+"conf"+System.getProperty("file.separator")+this.dir;
            filePath+=System.getProperty("file.separator")+request.getParameter("file");
            fileName = request.getParameter("file").substring(request.getParameter("file").lastIndexOf("/") + 1);
