 ...
 */
public class RegistrationAdvancedSearchController extends SimpleFormController {

    private static Log log = LogFactory.getLog(RegistrationAdvancedSearchController.class);
