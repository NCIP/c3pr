...
public abstract class AbstractObjectPropertyReader implements ObjectPropertyReader {
	...
	public Object getPropertyValue(PropertyDescriptor pd) throws Exception {
		CustomMethodInvocater methodInvocater = new CustomMethodInvocater(currentObject, pd.getReadMethod(), new Object[] {});
	 ...
	 * @throws Exception
	 */
	private PropertyTokenHolder getPropertyNameTokens(Object obj, String propertyName) throws Exception {
		...
		tokens.propertyDescriptor = new PropertyDescriptor(tokens.actualName,
				obj.getClass());
		if (!keys.isEmpty()) {
