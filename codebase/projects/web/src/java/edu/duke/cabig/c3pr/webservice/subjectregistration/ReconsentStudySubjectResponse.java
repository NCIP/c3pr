...
@XmlRootElement(name = "ReconsentStudySubjectResponse", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistrationService")
public class ReconsentStudySubjectResponse {
