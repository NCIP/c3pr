...
@XmlRootElement(name = "FailSubjectScreeningResponse", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistrationService")
public class FailSubjectScreeningResponse {
