...
@XmlRootElement(name = "ImportRegistrationsResponse", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistrationService")
public class ImportRegistrationsResponse {
