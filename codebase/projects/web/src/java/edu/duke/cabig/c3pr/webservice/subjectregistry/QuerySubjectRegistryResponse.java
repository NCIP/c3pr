...
@XmlRootElement(name = "QuerySubjectRegistryResponse", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistryService")
public class QuerySubjectRegistryResponse {
