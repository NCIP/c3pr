 ...
 * <ul>
 * <li>It stores the servletContext provided during {@link #init} so that it may be accessed during
 * filter processing. It also exposes the spring application context associated with the servlet
 * context (if any).</li>
