...
public class HttpServletLazyCollectionInitializerImpl extends AbstractObjectPropertyReader implements ObjectPropertyTraverser, HttpServletLazyCollectionInitializer, Associater {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(HttpServletLazyCollectionInitializerImpl.class);
	...
	public ObjectPropertyTraverser createObjectPropertyTraverser(String objectPath){
		HttpServletLazyCollectionInitializerImpl nestedObjectPropertyEditor = new HttpServletLazyCollectionInitializerImpl(getCurrentObject(), objectPath);
	...
	public ObjectPropertyTraverser createObjectPropertyTraverser(Object obj, String objectPath){
		HttpServletLazyCollectionInitializerImpl nestedObjectPropertyEditor = new HttpServletLazyCollectionInitializerImpl(obj, objectPath);
		nestedObjectPropertyEditor.setRegisteredCollections(this.registeredCollections);
		return nestedObjectPropertyEditor;
	}
	...
	public void processLazyInitialization(Object object, int key, String collectionType) throws Exception{
	...
	public void laziliyInitialize(Object collection, Field collectionField,	int index) throws Exception{
	...
	public Field getField(){
		for (Field f : getCurrentObject().getClass().getDeclaredFields()) {
			if (f.getName().equals(getActualName()))
				return f;
		}
		return null;
	}
	...
	public boolean hasAssociation(Object o){
		if(registeredCollections.get(o.getClass())!=null)
			return true;
		return false;
	}
	
	public Method getMethod(Object o, Object param) throws Exception{
		return o.getClass().getMethod(registeredCollections.get(o.getClass()), new Class[]{param.getClass()});
	}
	...
	public void traversePropertyPath() throws Exception {
		...
		if (pos > -1) {
			...
			if (continueTraverse) {
				ObjectPropertyTraverser nestedObjectPropertyEditor = createObjectPropertyTraverser(obj, nestedPath);
	...
	public void traversePropertyValues(PropertyValues pvs) {
		...
		for (int i = 0; i < pvArray.length; i++) {
			ObjectPropertyTraverser nestedObjectPropertyEditor = createObjectPropertyTraverser( pvArray[i].getName());
			try {
				nestedObjectPropertyEditor.traversePropertyPath();
			} catch (Exception e) {
