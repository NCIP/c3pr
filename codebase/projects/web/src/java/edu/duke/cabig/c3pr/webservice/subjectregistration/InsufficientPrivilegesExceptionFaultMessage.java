 ...
 * 
 */
@WebFault(name = "InsufficientPrivilegesExceptionFault", targetNamespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistrationService")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: edu.duke.cabig.c3pr.webservice.subjectregistration.InsufficientPrivilegesExceptionFault
     */
