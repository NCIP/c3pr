 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://enterpriseservices.nci.nih.gov/SubjectRegistration}PerformedStudySubjectMilestone">
 *       &lt;sequence>
 ...
 *         &lt;element name="consentPresenter" type="{uri:iso.org:21090}ST"/>
 *         &lt;element name="subjectConsentAnswer" type="{http://enterpriseservices.nci.nih.gov/SubjectRegistration}SubjectConsentQuestionAnswer" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends PerformedStudySubjectMilestone
{
    ...
    protected List<SubjectConsentQuestionAnswer> subjectConsentAnswer;
     ...
     * {@link SubjectConsentQuestionAnswer }
     * 
     * 
     */
    public List<SubjectConsentQuestionAnswer> getSubjectConsentAnswer() {
        if (subjectConsentAnswer == null) {
            subjectConsentAnswer = new ArrayList<SubjectConsentQuestionAnswer>();
        }
