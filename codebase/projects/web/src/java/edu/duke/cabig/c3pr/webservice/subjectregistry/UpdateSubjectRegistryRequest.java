...
@XmlRootElement(name = "UpdateSubjectRegistryRequest", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistryService")
public class UpdateSubjectRegistryRequest {
