...
@XmlRootElement(name = "UpdateSubjectRegistryStatusHistoryResponse", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistryService")
public class UpdateSubjectRegistryStatusHistoryResponse {
