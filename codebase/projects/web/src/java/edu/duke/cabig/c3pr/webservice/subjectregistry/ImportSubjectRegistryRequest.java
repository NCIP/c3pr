...
@XmlRootElement(name = "ImportSubjectRegistryRequest", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistryService")
public class ImportSubjectRegistryRequest {
