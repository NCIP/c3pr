...
@XmlRootElement(name = "DiscontinueEnrollmentResponse", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistrationService")
public class DiscontinueEnrollmentResponse {
