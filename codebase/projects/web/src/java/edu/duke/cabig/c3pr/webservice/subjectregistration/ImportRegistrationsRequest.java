...
@XmlRootElement(name = "ImportRegistrationsRequest", namespace = "http://enterpriseservices.nci.nih.gov/SubjectRegistrationService")
public class ImportRegistrationsRequest {
