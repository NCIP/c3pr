 ...
 * 
 */
@WebServiceClient(name = "SubjectManagementService", targetNamespace = "http://enterpriseservices.nci.nih.gov/SubjectManagementService", wsdlLocation = "file:/C:/temp/Ivy/wsdl/SubjectManagement.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/C:/temp/Ivy/wsdl/SubjectManagement.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/C:/temp/Ivy/wsdl/SubjectManagement.wsdl', retrying as a local file");
