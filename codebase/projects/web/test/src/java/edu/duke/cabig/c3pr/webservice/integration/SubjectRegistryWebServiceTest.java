...
public class SubjectRegistryWebServiceTest extends C3PREmbeddedTomcatTestBase {
	...
	public static final String WS_ENDPOINT_SERVLET_PATH = "/services/services/SubjectRegistry";
	 ...
	 * 
	 */
	public void testSubjectRegistry() throws InterruptedException,
			IOException {

		try {
			testSuccessfulWebServiceOperation("InitiateSubjectRegistry");
...
//			testUnsuccessfulWebServiceOperation("BadCreateSubject");
	...
	private void testSuccessfulWebServiceOperation(final String operation)
		...
		// flexible solution.
		String s = expectedSoapResponse;
		s=s.replaceAll("[\\n\\t]", "");
        s=s.replaceAll("> *<", "><");
		assertEquals(s, soapResponse);
	...
	private String getTestSOAPEnvelope(String fileName) throws IOException {
		String soap = IOUtils.toString(SubjectRegistryWebServiceTest.class
