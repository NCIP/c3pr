...
@XmlSeeAlso({
    ...
    edu.duke.cabig.c3pr.webservice.testclient.subjectmanagement.ObjectFactory.class,
...
public interface SubjectManagement {
     ...
     * @param parameters
     * @return
     *     returns edu.duke.cabig.c3pr.webservice.testclient.subjectmanagement.CreateSubjectResponse
     ...
     * @param parameters
     * @return
     *     returns edu.duke.cabig.c3pr.webservice.testclient.subjectmanagement.QuerySubjectResponse
     * @throws SecurityExceptionFaultMessage
     * @throws InvalidSubjectDataExceptionFaultMessage
     */
    @WebMethod
     ...
     * @param parameters
     * @return
     *     returns edu.duke.cabig.c3pr.webservice.testclient.subjectmanagement.AdvancedQuerySubjectResponse
     * @throws InvalidSubjectDataExceptionFaultMessage
     * @throws SecurityExceptionFaultMessage
     */
    @WebMethod
     ...
     * @param parameters
     * @return
     *     returns edu.duke.cabig.c3pr.webservice.testclient.subjectmanagement.UpdateSubjectResponse
     * @throws UnableToCreateOrUpdateSubjectExceptionFaultMessage
     * @throws SecurityExceptionFaultMessage
     * @throws InvalidSubjectDataExceptionFaultMessage
     ...
     * @param parameters
     * @return
     *     returns edu.duke.cabig.c3pr.webservice.testclient.subjectmanagement.UpdateSubjectStateResponse
