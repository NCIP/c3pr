...
public class RegistrationDetailsControllerTest extends ControllerTestCase {
	...
	private RegistrationDetailsController controller = new RegistrationDetailsController();

	private StudyParticipantAssignmentDao registrationDao;
	
	private StudyParticipantAssignment registration;
	...
	protected void setUp() throws Exception {
		...
		registrationDao = registerMockFor(StudyParticipantAssignmentDao.class);
		registration = registerMockFor(StudyParticipantAssignment.class);
	...
	public void testReferenceData() throws Exception {
		...
		Map<String, Object> refdata = controller.getFlow().getTab(0).referenceData(registration);
	...
	public void testViewOnGet() throws Exception {
		...
		System.out.println(" View name is: " + mv.getViewName());
		assertEquals("registration/reg_details_study_participant", mv.getViewName());
	}
