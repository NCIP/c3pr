			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="100%" id="tabDisplay"><span class="current"><img
							src="<tags:imageUrl name="tabWhiteL.gif"/>" width="3" height="16"
							align="absmiddle">Enrollment Details <img
							src="<tags:imageUrl name="tabWhiteR.gif"/>" width="3" height="16"
						...
						<img src="<tags:imageUrl name="tabGrayR.gif"/>" width="3"
							height="16" align="absmiddle"><img
							src="<tags:imageUrl name="tabGrayL.gif"/>" width="3" height="16"
							align="absmiddle"> <a href="javascript:updatePage('_target5');">Registration
						Status</a> <img src="<tags:imageUrl name="tabGrayL.gif"/>"
				...
				<table width="500" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<table width="500" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td height="2" border="0"><b><span class="black">Treating
								Physician details:</span></b></td>

							</tr>

							<tr align="center" valign="top">
								<td colspan="2"><strong> First Name :</strong> Jeremy
								&nbsp;&nbsp;&nbsp;<strong>Last Name:</strong> Smith</td>
							</tr>
							<tr align="center" valign="top">
								<td colspan="2"><strong> Title:</strong> MD &nbsp;&nbsp;&nbsp;<strong>Gender:</strong>
								Male</td>
							</tr>
							<tr align="center" valign="top">
								<td colspan="2"><strong> Primary Identifier :</strong> FB987485
								&nbsp;&nbsp;&nbsp;<strong>Source:</strong> 1572</td>
							</tr>
							...
							<tr align="left" valign="top">
								<td colspan="2"><strong>Informed Consent Signed Date:</strong>
								02/11/2007</td>
							</tr>
							<tr align="left" valign="top">
								<td colspan="2"><strong>Informed Consent Version:</strong> 1.0</td>
							</tr>
