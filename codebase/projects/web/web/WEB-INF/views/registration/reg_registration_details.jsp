...
<%--<tags:instructions code="enrollment_details" />--%>
	...
	<c:if test="${command.studySubject.regWorkflowStatus == 'ON_STUDY' || (command.studySubject.regWorkflowStatus == 'PENDING' && 
	...
	<c:if test="${command.studySubject.scheduledEpoch.epoch.enrollmentIndicator == 'true' && command.studySubject.regWorkflowStatus != 'ON_STUDY' }">
		<div class="row">
