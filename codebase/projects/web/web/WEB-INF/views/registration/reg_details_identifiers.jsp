			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td><img src="spacer.gif" width="7"
							height="1"></td>
					</tr>
					<tr>
						<td colspan="2" class="tabBotL"><img
							src="spacer.gif" width="1" height="7"></td>
					</tr>

				</table>
				<!-- TABS LEFT END HERE --></td>
				<td><img src="spacer.gif" width="2"
					height="1"></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<img src="<tags:imageUrl name="tabGrayR.gif"/>" width="3"
							height="16" align="absmiddle"><img
							src="<tags:imageUrl name="tabGrayL.gif"/>" width="3" height="16"
							align="absmiddle"> <a href="javascript:updatePage('_target4');">Randomization</a>
						<img src="<tags:imageUrl name="tabGrayR.gif"/>" width="3"
							height="16" align="absmiddle"><img
							src="<tags:imageUrl name="tabGrayL.gif"/>" width="3" height="16"
				...
				<table width="500" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<table width="700" border="0" cellspacing="0" cellpadding="0"
							...
							<tr class="label">
									<td size="20" align="center" border="1"></td>
									<td size="20" align="center" border="1" align="center">Source<span
										class="red">*</span></td>
									<td width="20%" align="center" border="1" align="center">Identifier Type<span
										class="red">*</span></td>
									<td width="20%" align="center" border="1" align="center">Identifier<span
										class="red">*</span></td>
									<td width="20%" align="center" border="1" align="center">Primary Indicator</td>
								</tr>

								<tr>
										<td width="20% border=" 1" align="center"><a
											href="javascript:fireAction('removeIdentifier',${status.index});"><img
											src="<tags:imageUrl name="b-delete.gif"/>" border="0"></a></td>
										
							<td align="center"><select name="select" class="field1" width=%40%>
							...
							<td align="center"><input name="textfield3" type="text" class="field1"
								size="15"></td>

							

										<td width="20%" border="1" align="center"><input type=radio NAME="primary indicator" value="s">
