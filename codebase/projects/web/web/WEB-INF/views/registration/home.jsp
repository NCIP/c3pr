...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
	<tr>
		...
		<form id="searchStudyForm" name="searchStudyForm" method="post"
			action="searchStudy?inRegistration=true"><tags:panelBox
			title="Select Study" boxId="SelectStudy">
			<table width="100%" border="0" cellpadding="0" cellspacing="2" id="table1">
				<tr valign="top">
					<td width="10%"><img src="<tags:imageUrl name="Study.gif"/>"
						alt="Study Search" width="100" height="100" align="absmiddle"></td>
					<td width="90%">
					<table width="70%" border="0" cellspacing="5" cellpadding="0" id="table1">
						<tr>
							<td width="40%" class="label">Search Studies By:</td>
							<td class="label"><select id="searchType" name="searchType">
								<c:forEach items="${searchTypeRefDataStudy}" var="searchTypePrt">
		...
		<form id="searchSubjectForm" name="searchSubjectForm" method="post"
			action="searchParticipant?inRegistration=true"><tags:panelBox
			title="Select Subject" boxId="SelectSubject">
			<table width="100%" border="0" cellpadding="0" cellspacing="1"
				id="table1">
				<tr valign="top">
					<td width="10%"><img src="<tags:imageUrl name="Patient.gif"/>"
						alt="Study Search" width="100" height="100" align="absmiddle"></td>
					<td width="90%">
					<table width="70%" border="0" cellspacing="5" cellpadding="0"
						id="table1">
						<tr>
							<td width="40%" align="left" class="label">Search Subjects
							By:</td>
							<td align="left"><select id="searchType" name="searchType">
