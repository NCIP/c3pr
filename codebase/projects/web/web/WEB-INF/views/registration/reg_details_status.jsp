		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td colspan="2" class="tabBotL"><img src="spacer.gif" width="1"
							height="7"></td>
					</tr>

				</table>
				<!-- TABS LEFT END HERE --></td>
				<td><img src="spacer.gif" width="2" height="1"></td>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="100%" id="tabDisplay"><span class="tab"><img
							...
							align="absmiddle"><a href="javascript:updatePage('_target0');">Enrollment
						...
						<img src="<tags:imageUrl name="tabGrayR.gif"/>" width="3"
							...
							src="<tags:imageUrl name="tabWhiteL.gif"/>" width="3" height="16"
							align="absmiddle">Registration Status <img
							src="<tags:imageUrl name="tabWhiteR.gif"/>" width="3" height="16"
							align="absmiddle"></span></td>
						<td><img src="<tags:imageUrl name="spacer.gif"/>" width="7"
							height="1"></td>
					...
					<tr>
						<td colspan="2" class="tabBotR"><img src="spacer.gif" width="1"
							height="7"></td>
					</tr>
				</table>
				...
				<table width="500" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<table width="700" border="0" cellspacing="0" cellpadding="0"
							...
							<tr>
								<td class="label"><span class="red">*</span><em></em>The current
								registration is:</td>
							...
							<tr>
								<td class="label"><span class="red">*</span><em></em>Reason:</td>
								<td>Waiting for approval from CALGB</td>
							</tr>
							<tr valign="top">
								<td><img src="<tags:imageUrl name="spacer.gif"/>" width="1"
									height="1" class="heightControl"></td>
							...
							<tr>
							<tr>
								<td class="label"><span class="red">*</span><em></em>The subject
								is:</td>

									<td><select name="select" class="field1">
									<option selected>Off-Study</option>
									<option>On-Study</option>
								</select></td>
							</tr>
							<tr valign="top">
								<td><img src="<tags:imageUrl name="spacer.gif"/>" width="1"
