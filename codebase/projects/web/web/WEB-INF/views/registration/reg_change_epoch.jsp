...
<table border="0" cellspacing="5px" cellpadding="5" class="tablecontent"  width="100%">
	<tr>
		<th width="5%">&nbsp;</th>
		<th scope="col" width="20%"><b><fmt:message key="c3pr.common.epoch"/></b><tags:hoverHint keyProp="study.criteriafile" /></th>
		<th scope="col"><b><fmt:message key="c3pr.common.description"/></b><tags:hoverHint keyProp="study.criteriafile" /></th>
		<th scope="col" width="12%"><b><fmt:message key="c3pr.common.type"/></b><tags:hoverHint keyProp="study.criteriafile" /></th>
		<th scope="col" width="25%"><b><fmt:message key="c3pr.common.notes"/></b><tags:hoverHint keyProp="study.criteriafile" /></th>
	</tr>
