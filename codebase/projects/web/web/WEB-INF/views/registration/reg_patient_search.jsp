					...
					<form:form id="searchParticipant" name="searchParticipant"
						...
						<tr>
							...
							<td width="99%" height="43" valign="middle" id="title"><a
								href="../participant/createParticipant?url=register&studySiteId=${studySiteId }">Create
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0"
									...
									<c:forEach items="${participants}" var="participant">
										<tr align="center" id="row<%= i++ %>" class="results" onMouseOver="navRollOver('row<%= i-1 %>', 'on')"
											...
											onClick="document.location='register?participantId=${participant.id}&studySiteId=${studySiteId}'">
