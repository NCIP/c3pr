...
<tags:formPanelBox tab="${tab}" flow="${flow}" continueLabel="${empty command.shouldReserve? 'Save':command.shouldReserve?'Reserve':command.shouldRegister?'Register':command.shouldRandomize?'Register':'Enroll'}">
