				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						4. <a href="reg_stratify.htm">Stratify</a> <img src="images/tabGrayR.gif" width="3" height="16"
							...
							height="16" align="absmiddle"> 3. <a href="reg_randomize.htm">Randomize</a> <img
							src="images/tabGrayR.gif" width="3" height="16" align="absmiddle"></span><span class="current"><img
							src="images/tabGrayL.gif" width="3" height="16" align="absmiddle">
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td id="current">Confirm Registration for patient - John Smith</td>
