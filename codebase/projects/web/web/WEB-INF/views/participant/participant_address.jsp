	...
	<chrome:division title="Address">
		<div class="row">
			...
			<div class="value"><form:input size="58"
				path="participant.address.streetAddress" /></div>
		</div>
		<div class="row">
			<div class="label"><em></em> <b><fmt:message key="c3pr.common.city"/></b>&nbsp;</div>
			<div class="value"><form:input path="participant.address.city" /></div>
		</div>
		<div class="row">
			<div class="label"><span class="data"><em></em> <b><fmt:message key="c3pr.common.state"/></b>&nbsp;</span></div>
			<div class="value"><form:input path="participant.address.stateCode" /></div>
		</div>
		<div class="row">
			<div class="label"><em></em> <b><fmt:message key="c3pr.common.zip"/></b>&nbsp;</div>
			<div class="value"><form:input path="participant.address.postalCode" id="postalCode" cssClass="validate-ZIPCODE" /></div>
		</div>
        
        <div class="row">
			<div class="label"><em></em><em></em> <b><fmt:message key="c3pr.common.country"/></b>&nbsp;</div>
			<div class="value"><form:input path="participant.address.countryCode" /></div>
		</div>
	</chrome:division>
