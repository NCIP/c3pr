...
function clearField(field) {
  ...
  var systemIdentifierRowInserterProps = {
   ...
   var organizationIdentifierRowInserterProps = {
            ...
            initialIndex: ${command.HasMRN?fn:length(command.organizationAssignedIdentifiers):fn:length(command.organizationAssignedIdentifiers)+1},                            /* this is the initial count of the rows when the page is loaded  */
