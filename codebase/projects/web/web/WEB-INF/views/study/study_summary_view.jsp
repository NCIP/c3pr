        ...
        function changeStudyStatus(status) {
        	if (${fn:length(errors)} > 0){
        		...
        		if(${command.study.coordinatingCenterStudyStatus=='PENDING'}){
        			confirmChangeStudyStatus(status, "openWithDateMessage");
        		}else{
	...
	<div id="broadcastAction">
		<c:choose>
			...
			<c:when test="${command.study.cctsWorkflowStatus=='MESSAGE_SEND_CONFIRMED'}">
				<div align="left" style="font-size: 10pt; padding-top: 10px; padding-bottom: 10px; padding-left: 5px; padding-right: 5px">
