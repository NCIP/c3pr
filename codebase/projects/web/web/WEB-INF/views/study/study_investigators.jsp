...
Event.observe(window, "load", function() {
    ...
    $('createInvestigator').observe('click', function(event) {
    	...
    	win = new Window(
				{title: "Create Investigator", top:35, left:35, width:1100, height:400, zIndex:100,
...
<c:choose>
    ...
    <c:otherwise>
		...
		<table border="0" id="table1" cellspacing="10" width="100%">
			...
			<tags:errors path="studyOrganizations[0].studyInvestigators"/> 
			...
			<td valign="middle">
					<input type="button" value="Add >>" onclick="fireAction('addStudyDisease','0');" alt="Add Investigators"/>
	        </td>
			<td valign="top" width="45%">
