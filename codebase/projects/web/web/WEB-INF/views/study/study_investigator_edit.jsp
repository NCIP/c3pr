            ...
            <c:forEach varStatus="status" items="${command.studySites[selected_site].studyInvestigators}">
                <tr>
                    <td class="alt">
                        ...
                        <input type="hidden" id="investigator${status.index}"
                               name="studySites[${selected_site}].studyInvestigators[${status.index}].healthcareSiteInvestigator"
                               value="${selectedStudySite },${command.studySites[selected_site].studyInvestigators[status.index].healthcareSiteInvestigator.id }"/>
