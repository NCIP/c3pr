...
//	$(mode.basename).value = selectedChoice.id;
	$(mode.basename).value = $('selectedStudySite').value+","+selectedChoice.id;
//	alert($(mode.basename).value);
}
		...
		<c:forEach varStatus="status" items="${command.studySites[selected_site].studyInvestigators}">
			<tr>
				<td class="alt">
					...
					<input type="hidden" id="investigator${status.index}" name="studySites[${selected_site}].studyInvestigators[${status.index}].healthcareSiteInvestigator" value="${selectedStudySite },${command.studySites[selected_site].studyInvestigators[status.index].healthcareSiteInvestigator.id }"/>
