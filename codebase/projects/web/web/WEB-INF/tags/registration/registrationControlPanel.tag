...
<tags:controlPanel>
    ...
    <csmauthz:accesscontrol domainObject="${command.studySubject.studySite}" hasPrivileges="STUDYSUBJECT_OVERRIDE" authorizationCheckName="studySiteAuthorizationCheck">
