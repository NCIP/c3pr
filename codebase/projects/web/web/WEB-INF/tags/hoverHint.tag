...
<c:choose>
	<c:when test="${not empty id}"> 
		...
		onmouseover="$('${id}-help-content').style.display='block'" onmouseout="$('${id}-help-content').style.display='none'">
	    <span valign="center"><img src="<tags:imageUrl name='q.png'/>" height="13"/></span>
		</a>&nbsp;&nbsp;&nbsp;
	...
	<c:otherwise>
	    ...
	    <img src="<tags:imageUrl name='q.png'/>" height="13"/>
		</a>&nbsp;&nbsp;&nbsp;
