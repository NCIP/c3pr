...
var disableClick = ['Dashboard', 'Inbox', 'Registration', 'Studies', 'Person &amp; Organization', 'Administration', 'Advanced Search', 'Import', 'Subject', 'Investigator', 'Research Staff', 'Organization' ];
