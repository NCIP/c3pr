...
var disableClick = ['Dashboard', 'Inbox', 'Registration', 'Studies', 'Person &amp; Organization', 'Administration', 'Reporting', 'Import', 'Subject', 'Investigator', 'Research Staff', 'Organization' ];
