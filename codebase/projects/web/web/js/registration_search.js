...
/*
  ...
  if (blnStatus)
  {
    if (checkConsolidator())
    {
      if(checkShipper())
      {
        window.location.replace('registration_select.jsp');
        document.frmRegistrationSearch.submit();
      }
    }
  }
*/
        window.location.replace('registration_multi_select.jsp');
        document.frmRegistrationSearch.submit();
}
...
{
  document.frmRegistrationSearch.action = "registration_input.jsp";
  document.frmRegistrationSearch.submit();
}
