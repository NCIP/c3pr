 ...
 * @version $Id: JobApplicationSpecEditComp.java,v 1.1.1.1 2007-02-01 20:42:07 kherm Exp $
 */

public class JobApplicationSpecEditComp extends JobSpecComp {

    private transient static PortletLog log = SportletLog.getInstance(JobApplicationSpecViewComp.class);

    public JobApplicationSpecEditComp(ActionComponentFrame container, String compName)
        ...
        setDefaultAction("doJobApplicationSpecEdit");
        setDefaultJspPage("/jsp/job/generic/JobApplicationSpecComp.jsp");
    }

    public void doJobApplicationSpecEdit(Map parameters) throws PortletException {
        log.error("doJobApplicationSpecEdit");
