 ...
 * @version $Id: JobViewPage.java,v 1.1.1.1 2007-02-01 20:42:15 kherm Exp $
 */
...
public class JobViewPage extends BaseResourceViewPage {

    private transient static PortletLog log = SportletLog.getInstance(JobViewPage.class);
    ...
    public JobViewPage(ActionComponentFrame container, String compName) {
        super(container, compName);
        log.debug("JobViewPage()");
        ...
        // Default page
        setDefaultJspPage("/jsp/resource/browser/profiles/JobViewPage.jsp");
    }
