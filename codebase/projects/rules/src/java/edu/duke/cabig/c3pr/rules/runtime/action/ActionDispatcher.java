...
import gov.nih.nci.cabig.c3pr.rules.brxml.Notification;
...
public class ActionDispatcher {
    ...
    public void dispatchActionOld(String actionId, RuleContext ruleContext)  throws RuleException {
    ...
    public Object loadObject(String className) throws RuleException {
        try {
