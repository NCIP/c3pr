...
import edu.duke.cabig.c3pr.rules.common.AdverseEventEvaluationResult;
import edu.duke.cabig.c3pr.rules.exception.RuleException;
import edu.duke.cabig.c3pr.rules.exception.RuleSetNotFoundException;
...
public class BusinessRulesExecutionServiceImpl implements BusinessRulesExecutionService {
    ...
    public BusinessRulesExecutionServiceImpl()  throws RuleException {
        super();
        initializeRules();
    }
